...
FlexGroups および FlexGroups に適したワークロードの詳細については、 https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["NetApp FlexGroup Volume Best Practices and Implementation Guide"^]を参照してください。
